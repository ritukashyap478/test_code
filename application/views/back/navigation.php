			...
			<div class="nano-content">
				<ul id="mainnav-menu" class="list-group">
					...
					<li <?php if($page_name=="free_members"||$page_name=="premium_members"|| $page_name=="add_member" ||$page_name=="deleted_members"){ ?> class="active-sub active" <?php } ?>>
						...
						<ul class="collapse">
							<?php
							if ($this->Crud_model->admin_permission('free_members')){
                            ?>
							...
							<li <?php if($page_name=="deleted_members"){ ?> class="active-link" <?php } ?>>
					...
					<li <?php if($page_name=="packages"){ ?> class="active-link" <?php } ?>>
						<a href="<?=base_url()?>admin/packages">
							...
							<span class="menu-title"><?php echo translate('premium_plans')?></span>
						</a>
					</li>
