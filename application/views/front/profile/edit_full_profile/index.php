                            ...
                            <div class="widget">
                                <div class="card z-depth-2-top" id="profile_load">
                                    ...
                                    <div class="card-body" style="padding: 1.5rem 0.5rem;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            if(isset($education_and_career_data[0]['highest_education']) ){
                                                                $education_and_career_data[0]['highest_education'] = $education_and_career_data[0]['highest_education'];
                                                            }else{
                                        ...
                                        ?>
                                        <?php
                                        $front_sett = $this->db->get_where('frontend_settings', array('type' => 'hobbies_and_interest'))->row();
                                        if($front_sett){
                                            if ($front_sett->value == "yes") {
                                        ?>
                                        <div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
                                        ...
                                        ?>
                                        <?php
                                        $family_pro =  $this->db->get_where('frontend_settings', array('type' => 'family_info'))->row();

                                        if($family_pro) {
                                            if ($family_pro->value == "yes") {
                                        ?>
                                        <div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
