                        ...
                        <div class="form-card form-card--style-2 z-depth-3-top">
                            <div class="form-body">
                                <div class="text-center px-2">
                                    <h4 class="heading heading-4 strong-400 mb-4 font_light"><?php echo translate('set_your_password')?></h4>
                                </div>
                                <form class="form-default" role="form" method="post" action="<?=base_url()?>home/set_password/<?= $token ?>">
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="text-uppercase font_light"><?php echo translate('confirm_password')?></label>
                                                <input type="password" class="form-control input-sm" name="confirm_password" required>
                                            </div>
                                        </div>
                                    </div>
